...
import { MessageSquare, Mail, X, Search } from 'lucide-react'
...
// Channel icon component wrapper
const ChannelIconComponent = ({ channel, size = 12, className = '' }: { channel: string; size?: number; className?: string }) => {
  if (channel === 'whatsapp') {
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            <div className={`p-1 rounded ${channelColors[message.channel as keyof typeof channelColors] || 'bg-gray-100 text-gray-700'}`}>
                              <ChannelIconComponent channel={message.channel} size={12} />
                            </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        <div className={`p-1 rounded ${channelColors[thread.channel as keyof typeof channelColors] || 'bg-gray-100 text-gray-700'}`}>
                          <ChannelIconComponent channel={thread.channel} size={12} />
                        </div>
                        <span className="text-xs text-gray-500 dark:text-gray-400 capitalize">
                          ...
                          <div className={`flex ${m.isFromBusiness ? 'justify-end' : 'justify-start'}`}>
                            ...
                            >
                              ...
                              <div className="mt-1 flex items-center gap-1.5">
                                <div className={`p-0.5 rounded ${channelColors[m.channel as keyof typeof channelColors] || 'bg-gray-100 text-gray-600'}`}>
                                  <ChannelIconComponent channel={m.channel} size={10} />
                                </div>
