...
export default function CRMPipelinePage() {
  ...
  return (
    <div className="flex h-screen w-full bg-background-light dark:bg-background-dark">
      {/* Sidebar */}
      <aside className="flex w-20 flex-col items-center border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-navy-800 py-4 shrink-0">
        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-primary text-white mb-8">
        ...
        <nav className="flex flex-col items-center gap-4">
          <a className="flex h-12 w-12 items-center justify-center rounded-2xl text-gray-500 dark:text-gray-400 hover:bg-primary/10 hover:text-primary transition-colors" href="#">
          ...
          <a className="flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10 text-primary transition-colors" href="#">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/>
            </svg>
          </a>
        ...
        <div className="mt-auto flex flex-col items-center gap-4">
          <a className="flex h-12 w-12 items-center justify-center rounded-2xl text-gray-500 dark:text-gray-400 hover:bg-primary/10 hover:text-primary transition-colors" href="#">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-1.5 1.5c-.2.2-.51.2-.71 0l-1.5-1.5c-.2-.2-.2-.51 0-.71l1.5-1.5c.2-.2.51-.2.71 0l1.5 1.5c.2.2.2.51 0 .71z"/>
            </svg>
          </a>
          <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10" style={{backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAzOkN3mmOKWNjPwF8mH6xtAm1ly3btacU9H5f946axgBg0uTs-7psXXHH2PuMDPwUJk9n3SoIiBYpu2gQqpPyPpvHwoU56evFYg9V4ugaQa7TDE3GLuJeoH1lFR6Fx7FhCfiTbGomeWdAsbu8zw6y_a81VhSVVVgUzgLCb7kvDD4FersNMev3P0E9gFCwljn_tewWoEttWFvq_5gcagGJ36aHuxpxamPJuH3-KJtZwzJi3rwX0BZynDl2aTJo3ssDiMP8V4fWFXn8")'}}></div>
        </div>
      </aside>
